    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('brand', models.CharField(max_length=255)),
                ('model', models.CharField(max_length=255)),
                ('reference', models.CharField(editable=False, max_length=7, primary_key=True, serialize=False, unique=True)),
                ('num_serie', models.CharField(editable=False, max_length=6, unique=True)),
                ...
                ('discription', models.TextField(default='')),
                ('image', models.ImageField(default='', upload_to='images/')),
                ('Location', models.ForeignKey(default=4, on_delete=django.db.models.deletion.CASCADE, to='core.location', to_field='name')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('opperation', models.TextField(editable=False, max_length=255, unique=True)),
                ('Location', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='core.location', to_field='name')),
                ('reference', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='core.equipement', validators=[core.models.validate_reference])),
            ],
        ),
    ]
