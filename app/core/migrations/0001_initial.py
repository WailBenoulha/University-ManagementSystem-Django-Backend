    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('role', models.CharField(choices=[('admin', 'admin'), ('principal_manager', 'principal_manager'), ('allocation_manager', 'allocation_manager'), ('student', 'student'), ('researcher', 'researcher')], default='admin', editable=False, max_length=255)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('Equipement', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, to='core.reservedequip', to_field='reference', verbose_name='Equipment')),
            ],
        ),
        migrations.CreateModel(
            name='Inventory',
